...
describe("Set the expiry datetime", () => {
  ...
  it("should return the expiry date with todays date", () => {
    let expected =
      "Tue Jan 21 2020 11:55:07 GMT+0800 (Singapore Standard Time)";
    let actual = calculateExpiryDate(
      new Date("2020-01-20T17:55:07+0800"),
      schedule,
      expireyTime
    ).toString();
  ...
  it("should return the expiry date to next working day", () => {
    let expected =
      "Mon Jan 20 2020 12:00:07 GMT+0800 (Singapore Standard Time)";
    let actual = calculateExpiryDate(
      new Date("2020-01-19T11:00:07+0800"),
      schedule,
      expireyTime
    ).toString();
  ...
  it("should return the expiry date on Monday", () => {
    let expected =
      "Mon Jan 20 2020 12:55:07 GMT+0800 (Singapore Standard Time)";
    let actual = calculateExpiryDate(
      new Date("2020-01-18T14:55:07+0800"),
      schedule,
      expireyTime
    ).toString();
  ...
  it("should add the expiry today and next day", () => {
    let expected =
      "Wed Jan 22 2020 11:30:07 GMT+0800 (Singapore Standard Time)";
    let actual = calculateExpiryDate(
      new Date("2020-01-21T17:30:07+0800"),
      schedule,
      expireyTime
    ).toString();
